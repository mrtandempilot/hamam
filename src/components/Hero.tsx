...
const Hero = () => {
  ...
  return (
    ...
    >
      {/* WhatsApp Button */}
      <a
        href="https://wa.me/905362222813"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed right-6 bottom-6 z-50 bg-green-500 text-white p-4 rounded-full shadow-lg hover:bg-green-600 transition-colors duration-300 flex items-center gap-2"
